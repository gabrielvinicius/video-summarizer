...
class ApplicationContainer:
    ...
    def _setup_video_services(self, db_session: AsyncSession) -> None:
        """Configura serviços relacionados a vídeos"""
        self._services["video_repository"] = get_video_repository(db_session)
        self._services["video_service"] = get_video_service(db_session)
    ...
    def _setup_summarization_services(self, db_session: AsyncSession) -> None:
